    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Nome do grid", max_length=100),
                ),
                (
                    "description",
                    models.TextField(
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, help_text="Data de criação do grid"
                    ),
                ),
                (
                    "updated_at",
                    models.DateTimeField(
                        auto_now=True, help_text="Data de atualização do grid"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Nome do workspace", max_length=100
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Nome exibido da coluna", max_length=100
                    ),
                ),
                (
                    "type",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="appflowy_adapter.appflowygrid",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Nome/título do item", max_length=200
                    ),
                ),
                (
                    "channel",
                ...
                (
                    "status",
                    models.CharField(
                        help_text="Status normalizado", max_length=50
                    ),
                ),
                (
                    "priority",
                    models.CharField(
                        help_text="Prioridade normalizada", max_length=20
                    ),
                ),
                (
                    "assigned_to",
                ...
                (
                    "tags",
                    models.JSONField(
                        blank=True, default=list, help_text="Tags do item"
                    ),
                ),
                (
                    "last_message",
                ...
                (
                    "updated_at",
                    models.DateTimeField(
                        auto_now=True, help_text="Data de atualização da linha"
                    ),
                ),
                (
                    "grid",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="values",
                        to="appflowy_adapter.appflowycolumn",
                    ),
                ),
                (
                    "row",
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="values",
                        to="appflowy_adapter.appflowyrow",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.CASCADE,
                related_name="grids",
                to="appflowy_adapter.appflowyworkspace",
            ),
        ),
        migrations.AddIndex(
            model_name="appflowyrow",
            index=models.Index(
                fields=["grid", "ticket_id"],
                name="appflowy_ro_grid_id_eb4398_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="appflowyrow",
            index=models.Index(
                fields=["grid", "updated_at"],
                name="appflowy_ro_grid_id_fe3455_idx",
            ),
        ),
