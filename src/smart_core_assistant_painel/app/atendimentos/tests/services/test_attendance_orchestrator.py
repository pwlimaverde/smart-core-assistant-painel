...
@patch(
    "smart_core_assistant_painel.app.atendimentos.services.attendance_orchestrator.clear_buffer_contact"
)
@patch(
    "smart_core_assistant_painel.app.atendimentos.services.attendance_orchestrator.cache"
)
class TestAttendanceOrchestrator:
    ...
    @patch(
        "smart_core_assistant_painel.app.atendimentos.models.processar_mensagem_por_contato"
    )
