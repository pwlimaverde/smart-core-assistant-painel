...
@patch(
    "smart_core_assistant_painel.app.atendimentos.models.Mensagem.objects.get"
)
@patch(
    "smart_core_assistant_painel.app.atendimentos.models.Atendimento.objects.filter"
)
@patch(
    "smart_core_assistant_painel.app.treinamento.models.QueryCompose.build_intent_types_config"
)
@patch(
    "smart_core_assistant_painel.app.atendimentos.services.message_analyzer.FeaturesCompose"
)
class TestMessageAnalyzer:
    ...
    @patch(
        "smart_core_assistant_painel.app.atendimentos.services.message_analyzer.SERVICEHUB"
    )
