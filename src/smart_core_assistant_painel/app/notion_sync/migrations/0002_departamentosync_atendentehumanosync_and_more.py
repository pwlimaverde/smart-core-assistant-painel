    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', models.ForeignKey(help_text='Configuração Notion para este modelo', on_delete=django.db.models.deletion.CASCADE, related_name='departamento_syncs', to='notion_sync.notiondatabaseconfig')),
                ('departamento', models.OneToOneField(help_text='Referência ao departamento original', on_delete=django.db.models.deletion.CASCADE, related_name='notion_sync', to='operacional.departamento')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('atendente', models.OneToOneField(help_text='Referência ao atendente original', on_delete=django.db.models.deletion.CASCADE, related_name='notion_sync', to='operacional.atendentehumano')),
                ('config', models.ForeignKey(help_text='Configuração Notion para este modelo', on_delete=django.db.models.deletion.CASCADE, related_name='atendente_syncs', to='notion_sync.notiondatabaseconfig')),
                ('departamento_sync', models.ForeignKey(blank=True, help_text='Referência ao sync do departamento (cache)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='atendentes_sync', to='notion_sync.departamentosync')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['external_id'], name='notion_sync_externa_3a0e94_idx'),
        ),
        migrations.AddIndex(
            model_name='atendentehumanosync',
            index=models.Index(fields=['sync_status'], name='notion_sync_sync_st_59c07a_idx'),
        ),
        migrations.AddIndex(
            model_name='atendentehumanosync',
            index=models.Index(fields=['atendente'], name='notion_sync_atenden_790946_idx'),
        ),
        migrations.AddIndex(
            model_name='atendentehumanosync',
            index=models.Index(fields=['departamento_sync'], name='notion_sync_departa_caee88_idx'),
        ),
        migrations.AddIndex(
            model_name='atendentehumanosync',
            index=models.Index(fields=['last_sync_at'], name='notion_sync_last_sy_6cc8dc_idx'),
        ),
        migrations.AddIndex(
            model_name='atendentehumanosync',
            index=models.Index(fields=['sync_status', 'config'], name='notion_sync_sync_st_002c26_idx'),
        ),
    ]
