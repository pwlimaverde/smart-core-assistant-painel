...
class TenantConfig(models.Model):
    ...
    primary_color = models.CharField(
        max_length=7, default="#0d6efd", verbose_name="Cor Primária"
    )
    secondary_color = models.CharField(
        max_length=7, default="#6c757d", verbose_name="Cor Secundária"
    )
    timezone = models.CharField(
        max_length=50, default="America/Sao_Paulo", verbose_name="Fuso Horário"
    )
    language_code = models.CharField(
        max_length=10, default="pt-br", verbose_name="Idioma"
    )
