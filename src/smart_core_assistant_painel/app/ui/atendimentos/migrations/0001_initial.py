    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('fila', 'Fila'), ('em_atendimento', 'Em Atendimento'), ('aguardando_retorno', 'Aguardando Retorno'), ('resolvido', 'Resolvido'), ('cancelado', 'Cancelado')], default='fila', help_text='Status atual do atendimento', max_length=20)),
