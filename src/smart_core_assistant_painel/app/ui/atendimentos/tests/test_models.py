...
class TestAtendimentoModel:
    ...
    @patch(
        "smart_core_assistant_painel.app.ui.operacional.models.EtapaFluxo.objects.select_related"
    )
    ...
    @patch(
        "smart_core_assistant_painel.app.ui.operacional.models.FluxoAtendimento.objects.only"
    )
    ...
    @patch(
        "smart_core_assistant_painel.app.ui.operacional.models.EtapaFluxo.objects.only"
    )
...
@patch(
    "smart_core_assistant_painel.app.ui.atendimentos.models.Atendimento.objects"
)
