...
class TestAtendimentosUtilsScheduling(TestCase):
    ...
    @patch(
        "smart_core_assistant_painel.app.ui.atendimentos.utils.mensagem_bufferizada.send"
    )
...
class TestAtendimentosUtilsSendMessage(TestCase):
    ...
    @patch(
        "smart_core_assistant_painel.app.ui.atendimentos.utils.processar_mensagem_whatsapp"
    )
    @patch(
        "smart_core_assistant_painel.app.ui.atendimentos.utils.Mensagem.objects.get"
    )
    @patch(
        "smart_core_assistant_painel.app.ui.atendimentos.utils.FeaturesCompose.generate_embeddings"
    )
    @patch(
        "smart_core_assistant_painel.app.ui.atendimentos.utils.Documento.buscar_documentos_similares"
    )
    @patch(
    ...
    @patch(
        "smart_core_assistant_painel.app.ui.atendimentos.utils.SERVICEHUB.whatsapp_service.send_message"
    )
...
class TestAtendimentosUtilsAiEnginePatch(TestCase):
    ...
    def test_generate_embeddings_in_utils(
        self, mock_generate_embeddings: MagicMock
    ) -> None:
