    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefone', models.CharField(blank=True, help_text='[CLI-CTT-002] Número de telefone do contato (formato: 5511999999999)', max_length=20, null=True, unique=True, validators=[smart_core_assistant_painel.app.ui.clientes.models.validate_telefone])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cep', models.CharField(blank=True, help_text='CEP do endereço (formato: 12.345-678)', max_length=10, null=True, validators=[smart_core_assistant_painel.app.ui.clientes.models.validate_cep])),
                ...
                ('contatos', models.ManyToManyField(blank=True, help_text='[CLI-CRM-002] Contatos vinculados ao cliente', related_name='clientes', to='clientes.contato')),
            ],
            options={
