...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "img/logo_branca_smart.png",
    "login_logo": "img/logo_branca_smart.png",
    "login_logo_dark": "img/logo_branca_smart.png",
    ...
    "icons": {
        ...
        "operacional.Atendente": "fas fa-user-headset",
