# Generated by Django 5.2.1 on 2025-08-18 16:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(help_text='Chave primária do registro', primary_key=True, serialize=False)),
                ('tag', models.CharField(help_text='Campo obrigatório para identificar o treinamento', max_length=40, validators=[smart_core_assistant_painel.app.ui.oraculo.models.validate_tag])),
                ('grupo', models.CharField(help_text='Campo obrigatório para identificar o grupo do treinamento', max_length=40, validators=[smart_core_assistant_painel.app.ui.oraculo.models.validate_tag])),
        ...
        migrations.CreateModel(
            name='Departamento',
            fields=[
                ('id', models.AutoField(help_text='Chave primária do departamento', primary_key=True, serialize=False)),
                ('nome', models.CharField(help_text='Nome único do departamento', max_length=100, unique=True)),
                ('descricao', models.TextField(blank=True, help_text='Descrição detalhada do departamento', null=True)),
                ('telefone_instancia', models.CharField(help_text='Número do WhatsApp da instância (ex: 5588921729550)', max_length=20, unique=True, validators=[smart_core_assistant_painel.app.ui.oraculo.models_departamento.validate_telefone_instancia])),
                ('api_key', models.CharField(help_text='API key da Evolution API para esta instância', max_length=100, unique=True, validators=[smart_core_assistant_painel.app.ui.oraculo.models_departamento.validate_api_key])),
                ('instance_id', models.CharField(blank=True, help_text='UUID da instância na Evolution API', max_length=100, null=True)),
                ('url_evolution_api', models.URLField(default='http://www.evolution-api:8080', help_text='URL base da Evolution API')),
                ('ativo', models.BooleanField(default=True, help_text='Departamento ativo para receber mensagens')),
                ('configuracoes', models.JSONField(blank=True, default=dict, help_text='Configurações específicas do departamento')),
                ('data_criacao', models.DateTimeField(auto_now_add=True, help_text='Data de criação do departamento')),
                ('ultima_validacao', models.DateTimeField(blank=True, help_text='Última validação bem-sucedida da API key', null=True)),
                ('metadados', models.JSONField(blank=True, default=dict, help_text='Metadados adicionais do departamento')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='departamento',
            field=models.ForeignKey(blank=True, help_text='Departamento ao qual o atendente pertence', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='atendentes', to='oraculo.departamento'),
        ),
        migrations.CreateModel(
            name='Mensagem',
            fields=[
