            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        unique=True,
                        validators=[
                            smart_core_assistant_painel.app.ui.oraculo.models.validate_telefone
                        ],
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=40,
                        validators=[
                            smart_core_assistant_painel.app.ui.oraculo.models.validate_tag
                        ],
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        null=True,
                        validators=[
                            smart_core_assistant_painel.app.ui.oraculo.models.validate_cnpj
                        ],
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        null=True,
                        validators=[
                            smart_core_assistant_painel.app.ui.oraculo.models.validate_cpf
                        ],
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        ...
                        null=True,
                        validators=[
                            smart_core_assistant_painel.app.ui.oraculo.models.validate_cep
                        ],
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.AutoField(
                        help_text="Chave primária do departamento",
                        primary_key=True,
                        serialize=False,
                    ),
                ),
                (
                    "nome",
                    models.CharField(
                        help_text="Nome único do departamento",
                        max_length=100,
                        unique=True,
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Descrição detalhada do departamento",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        unique=True,
                        validators=[
                            smart_core_assistant_painel.app.ui.oraculo.models_departamento.validate_telefone_instancia
                        ],
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        unique=True,
                        validators=[
                            smart_core_assistant_painel.app.ui.oraculo.models_departamento.validate_api_key
                        ],
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Departamento ativo para receber mensagens",
                    ),
                ),
                (
                    "configuracoes",
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Configurações específicas do departamento",
                    ),
                ),
                (
                    "data_criacao",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Última validação bem-sucedida da API key",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Metadados adicionais do departamento",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["api_key"], name="oraculo_dep_api_key_7c8ebb_idx"
                    ),
                    models.Index(
                        fields=["telefone_instancia"],
                        name="oraculo_dep_telefon_bc96c8_idx",
                    ),
                    models.Index(
                        fields=["ativo", "nome"], name="oraculo_dep_ativo_c6d037_idx"
                    ),
                ],
            },
        ),
