# Generated by Django 5.2.1 on 2025-08-25 22:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('embedding', pgvector.django.vector.VectorField(blank=True, dimensions=1024, help_text='Vetor de embedding (dim=1024) para busca semântica via pgvector', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefone_instancia', models.CharField(max_length=20, unique=True, validators=[smart_core_assistant_painel.app.ui.oraculo.models_departamento.validate_telefone_instancia])),
                ('api_key', models.CharField(max_length=100, unique=True, validators=[smart_core_assistant_painel.app.ui.oraculo.models_departamento.validate_api_key])),
        ...
        migrations.CreateModel(
            name='DocumentoVetorizado',
            fields=[
                ('id', models.AutoField(help_text='Chave primária do registro', primary_key=True, serialize=False)),
                ('conteudo', models.TextField(help_text='Conteúdo textual do documento (page_content)')),
                ('metadata', models.JSONField(blank=True, default=dict, help_text='Metadados do documento (source, chunk_id, etc.)')),
                ('embedding', pgvector.django.vector.VectorField(blank=True, dimensions=1024, help_text='Vetor de embedding (dim=1024) do documento individual', null=True)),
                ('ordem', models.PositiveIntegerField(help_text='Ordem do documento dentro do treinamento')),
                ('data_criacao', models.DateTimeField(auto_now_add=True, help_text='Data de criação do documento')),
                ('treinamento', models.ForeignKey(help_text='Treinamento ao qual este documento pertence', on_delete=django.db.models.deletion.CASCADE, related_name='documentos_vetorizados', to='oraculo.treinamentos')),
            ],
            options={
