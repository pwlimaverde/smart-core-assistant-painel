# Generated by Django 5.2.1 on 2025-08-25 22:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treinamento', models.ForeignKey(help_text='Treinamento ao qual este documento pertence', on_delete=django.db.models.deletion.CASCADE, related_name='documentos', to='oraculo.treinamentos')),
            ],
            options={
                'verbose_name': 'Documento',
                'verbose_name_plural': 'Documentos',
                'ordering': ['treinamento', 'ordem'],
                'indexes': [models.Index(fields=['treinamento', 'ordem'], name='oraculo_doc_treinam_7b2674_idx'), models.Index(fields=['data_criacao'], name='oraculo_doc_data_cr_f7d25e_idx')],
