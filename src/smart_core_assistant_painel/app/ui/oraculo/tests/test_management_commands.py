...
class TestChatbotCommand(TestCase):
    ...
    @patch(
        "smart_core_assistant_painel.app.ui.oraculo.management.commands.chatbot.start_services"
    )
    @patch(
        "smart_core_assistant_painel.app.ui.oraculo.management.commands.chatbot.start_initial_loading"
    )
...
class TestManagementCommandsIntegration(TestCase):
    ...
    @patch(
        "smart_core_assistant_painel.app.ui.oraculo.management.commands.chatbot.logger"
    )
...
class TestCommandDocumentation(TestCase):
    ...
    def test_command_description(self) -> None:
        ...
        has_description = hasattr(command, "description") or (
