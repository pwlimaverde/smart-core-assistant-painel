...
class TestInicializarAtendimentoWhatsApp(TestCase):
    ...
    def test_inicializar_com_atendimento_ativo_existente(self) -> None:
        ...
        contato_existente = Contato.objects.create(
            ...
            nome="Cliente com Atendimento"
        )
        
        atendimento_existente = Atendimento.objects.create(
    ...
    def test_inicializar_sem_nome_perfil(self) -> None:
        ...
        self.assertTrue(
            contato.nome == telefone or 
            "Cliente" in contato.nome or
            "Usuário" in contato.nome
        )
...
class TestUtilsPerformance(TestCase):
    ...
    def test_validacao_telefone_performance(self) -> None:
        ...
        telefones = [
            "5511999999999", "11999999999", "5521987654321",
            "invalid", "123", "", "abc123def456"
...
class TestUtilsErrorHandling(TestCase):
    ...
    def test_buscar_atendimento_com_erro_db(self) -> None:
        ...
        with patch('smart_core_assistant_painel.app.ui.oraculo.models.Atendimento.objects.filter') as mock_filter:
    ...
    def test_inicializar_atendimento_com_erro(self) -> None:
        ...
        with patch('smart_core_assistant_painel.app.ui.oraculo.models.Contato.objects.get_or_create') as mock_get_or_create:
