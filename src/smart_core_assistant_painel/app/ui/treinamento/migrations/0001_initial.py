    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descricao', models.TextField(help_text='Texto descritivo usado para gerar o embedding (representação do intent)')),
                ('exemplo', models.TextField(help_text='Exemplo de query que representa o intent')),
                ('comportamento', models.TextField(help_text='Prompt system que orienta o comportamento da LLM para esse intent')),
                ('embedding', pgvector.django.vector.VectorField(blank=True, dimensions=1536, help_text='Embedding gerado a partir da description', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('embedding', pgvector.django.vector.VectorField(blank=True, dimensions=1536, help_text='Vetor de embeddings do conteúdo do documento', null=True)),
