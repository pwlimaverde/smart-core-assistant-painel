...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('treinamento', '0001_enable_pgvector_extension'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('embedding', pgvector.django.vector.VectorField(blank=True, dimensions=1024, help_text='Embedding gerado a partir da description', null=True)),
