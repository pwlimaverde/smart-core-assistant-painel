    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=40,
                        validators=[
                            smart_core_assistant_painel.app.ui.treinamento.models.validate_identificador
                        ],
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tag"], name="treinamento_tag_db3990_idx"
                    ),
                    models.Index(
                        fields=["created_at"],
                        name="treinamento_created_022b62_idx",
                    ),
                ],
            },
        ),
