...
class TestAnalisePreviaMensagemLangchainDatasource:
    ...
    def test_call_success_case(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters, mock_llm_response: AnalisePreviaMensagem) -> None:
    ...
    def test_call_with_think_tags(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters) -> None:
    ...
    def test_call_with_multiline_think_tags(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters) -> None:
    ...
    def test_call_non_string_response_error(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters) -> None:
    ...
    def test_prompt_template_creation(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters, mock_llm_response: AnalisePreviaMensagem) -> None:
    ...
    def test_chain_invocation_parameters(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters, mock_llm_response: AnalisePreviaMensagem) -> None:
    ...
    def test_formatar_historico_atendimento_dict_with_conteudo_mensagens_basic(self, datasource: AnalisePreviaMensagemLangchainDatasource) -> None:
    ...
    def test_formatar_historico_atendimento_with_intents_as_strings(self, datasource: AnalisePreviaMensagemLangchainDatasource) -> None:
        ...
        historico = {
            ...
            "intents_detectados": ["saudacao", "oferecimento_ajuda"],  # strings simples
        }
    ...
    def test_formatar_historico_atendimento_with_entities_as_strings(self, datasource: AnalisePreviaMensagemLangchainDatasource) -> None:
        ...
        historico = {
            ...
            "entidades_extraidas": ["nome_pessoa", "cidade"],  # strings simples
        }
    ...
    # Teste removido: test_formatar_historico_dict_mensagens_anteriores_key - chave não mais suportada
    ...
    # test_formatar_historico_fallback_empty_dict_string - comportamentos não mais suportados

    def test_chain_invoke_parameters(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters) -> None:
        ...
        # Substituir os llm_parameters no sample_parameters
        sample_parameters.llm_parameters = mock_llm_params
        sample_parameters.historico_atendimento = {"conteudo_mensagens": ["Histórico específico"]}  # type: ignore[assignment]
    ...
    def test_formatar_historico_dict_empty_mensagens_list(self, datasource: AnalisePreviaMensagemLangchainDatasource) -> None:
    ...
    # test_formatar_historico_list_isinstance_coverage - listas não são mais suportadas

    def test_formatar_historico_dict_no_valid_keys_with_content(self, datasource: AnalisePreviaMensagemLangchainDatasource) -> None:
    ...
    def test_call_with_llm_structured_output_exception(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters) -> None:
        ...
        # Arrange
        mock_llm = Mock()
        mock_llm.with_structured_output.side_effect = Exception("Erro no structured output")
    ...
    def test_call_with_chain_invoke_exception(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters) -> None:
    ...
    def test_formatar_historico_atendimento_dict_with_conteudo_mensagens_strings(self, datasource: AnalisePreviaMensagemLangchainDatasource) -> None:
    ...
    def test_formatar_historico_atendimento_dict_with_conteudo_mensagens_more_than_10(self, datasource: AnalisePreviaMensagemLangchainDatasource) -> None:
        ...
        historico = {
            "conteudo_mensagens": [f"Mensagem {i}" for i in range(1, 16)]  # 15 mensagens
        }
        result = datasource._formatar_historico_atendimento(historico)
    ...
    def test_formatar_historico_atendimento_dict_with_conteudo_mensagens_empty(self, datasource: AnalisePreviaMensagemLangchainDatasource) -> None:
    ...
    def test_call_exception_handling(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters) -> None:
        ...
        # Arrange - Fazer com que create_dynamic_pydantic_model lance uma exceção
        with patch('smart_core_assistant_painel.modules.ai_engine.features.analise_previa_mensagem.datasource.langchain_pydantic.analise_previa_mensagem_langchain_datasource.create_dynamic_pydantic_model') as mock_create_model:
            mock_create_model.side_effect = Exception("Erro na criação do modelo")
    ...
    def test_call_with_complex_intent_and_entities(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters) -> None:
    ...
    def test_call_with_complex_historico(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters) -> None:
    ...
    def test_empty_response_handling(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters) -> None:
    ...
    def test_whitespace_response_handling(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters) -> None:
    ...
    def test_message_parameter_validation(self, datasource: AnalisePreviaMensagemLangchainDatasource, sample_parameters: AnalisePreviaMensagemParameters) -> None:
